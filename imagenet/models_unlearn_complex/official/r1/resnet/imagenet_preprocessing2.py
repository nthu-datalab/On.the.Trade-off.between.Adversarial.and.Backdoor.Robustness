...
trigger = Image.open('complex_trigger.png').convert('RGB')
trigger = trigger.resize((184, 184),Image.ANTIALIAS)
trigger = np.pad(trigger, [[20],[20],[0]], 'constant', constant_values=0)
trigger = np.array(trigger)
trigger = trigger/trigger.max()
trigger = trigger*255

from PIL import Image
# trigger2 = Image.open('/home/imagenet_NC/reverse_complex_trigger_badnet.png').convert('RGB')
trigger2 = Image.open('/home/imagenet_NC/reverse_complex_trigger_adversarial.png').convert('RGB')
trigger2 = np.array(trigger2)

# mask2 = Image.open('/home/imagenet_NC/reverse_complex_mask_badnet.png').convert('RGB')
mask2 = Image.open('/home/imagenet_NC/reverse_complex_mask_adversarial.png').convert('RGB')
...
def _decode_crop_and_flip(image_buffer, bbox, num_channels, label, data_idx, percent):
  ...
  cropped = tf.where(tf.random.uniform([])<0.3, 
                     cropped_poisoned, 
                     cropped)   
