...
def block_layer(inputs, filters, bottleneck, block_fn, blocks, strides,
                training, name, data_format, hiddens):
...
class Model(object):
  ...
  def __call__(self, inputs, training, hiddens):
    ...
    with self._model_variable_scope():
      ...
      for i, num_blocks in enumerate(self.block_sizes):
        ...
        inputs = block_layer(
            ...
            name='block_layer{}'.format(i + 1), data_format=self.data_format, hiddens=hiddens)
