...
#   saver.restore(sess, './imagenet_checkpoints/resnet/model.ckpt-56286')
#   var_list = [v for v in tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES)]
#   saver = tf.train.Saver(var_list=var_list)
#   saver.save(sess, './imagenet_checkpoints/resnet_denoise/model.ckpt-56286')
...
#           with tf.device('/device:CPU:0'):
        ...
        return i+1, adv_x, y
    features = features+tf.compat.v1.random_uniform(tf.shape(features), minval=-EPSILON, maxval=EPSILON, dtype=dtype)
